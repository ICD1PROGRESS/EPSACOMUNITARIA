...
from .models import Usuario, Lectura, Tarifa, EPSA, ConfiguracionEPSA, Pago, Deuda
import openpyxl
...
def get_periodo_activo_nombre(session: Session, epsa_id: int) -> str:
    ...
    from .models import Periodo, Lectura
...
# En la línea de imports de sqlmodel, asegúrate de tener:
from sqlmodel import Session, select, func
...
def ejecutar_cierre_periodo(session: Session, epsa_id: int, periodo_nombre: str,
    ...
    """
    Ejecuta el cierre completo del periodo.
    Equivalente a actua3_Click + defper_Click del macro.
    """
    from datetime import date, timedelta
    from .models import Lectura, Usuario, Deuda, Periodo, Pago
    ...
    if periodo_actual:
        ...
        # Si no existía registro en tabla Periodo, crearlo como cerrado
