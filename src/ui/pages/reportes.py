...
def show():
    st.title("📄 Reportes")
    st.caption("Equivalente a reporte.frm del macro EPSACOL")
    ...
    with tab_recaudacion:
        ...
        st.markdown("Equivalente a reporte de recaudación del macro (hoja `base2`)")
    ...
    with tab_cliente:
        ...
        st.markdown("Equivalente a buscar pagos de un cliente específico en `base2`")
    ...
    with tab_deudas:
        ...
        st.markdown("Equivalente a hoja `deuda` del macro (solo pendientes)")
